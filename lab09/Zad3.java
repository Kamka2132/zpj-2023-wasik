...
public class Zad3 {
    public static void main(String[] args) {
        ...
        List<BigInteger> parallelPrimes = Stream.generate(Zad3::generateRandomBigInteger)
                .parallel()
        ...
        List<BigInteger> sequentialPrimes = Stream.generate(Zad3::generateRandomBigInteger)
                .filter(number -> number.isProbablePrime(50)) // Używamy wartości pewności 50
                .limit(500)
                .collect(Collectors.toList());
    ...
    private static BigInteger generateRandomBigInteger() {
        return new BigInteger(50, 100, Zad3.getRandom());
    }
